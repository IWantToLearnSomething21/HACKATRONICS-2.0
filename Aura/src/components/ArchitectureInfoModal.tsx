      ...
      <div className="bg-amber-50/70 border border-amber-200/80 rounded-xl p-5 text-amber-900 flex items-start gap-3.5">
        ...
        <div className="space-y-1 text-xs">
          ...
          <p className="leading-relaxed text-amber-800/90">
            This prototype is designed for research evaluation and demonstration of machine learning feature pipelines and automated hospital escalation routing. It does not constitute medical advice or a certified medical device under FDA or CE Mark regulations.
          </p>
        </div>
      </div>
